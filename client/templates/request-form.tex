...
\lineh{0}{20}{190}   %first horizontal line at top of page under company name and branch address
\lineh{0}{31}{190}   %second horizontal line at top of page under labels billling, Our Reference, Your Reference and the Practitioners Name
\lineh{0}{70}{190}   %third horizontal line, under the patient's name and address, and the practices name and address


\linev{0}{20}{235}    % sidelines
\linev{190}{20}{235}

\linev{130}{20}{105} % broken vertical separator
%\linev{130}{220}{35}
...
\text{3}{25}{35}{      %write in first rectangle at top left - billing information
\textbf{\footnotesize Billing}\\
 \footnotesize !billing}

\text{45}{25}{35}{      %write in second rectangle at top  - practice patient reference
