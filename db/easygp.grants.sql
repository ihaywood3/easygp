...
GRANT ALL ON TABLE clin_prescribing.items_prescribed TO staff;
GRANT ALL ON TABLE clin_prescribing.link_generics_brands TO staff;
GRANT ALL ON TABLE clin_prescribing.medications TO staff;
GRANT ALL ON TABLE clin_prescribing.script_dates TO staff;
GRANT ALL ON TABLE clin_prescribing.vwpatientsmedications TO staff;
...
GRANT ALL ON TABLE clin_referrals.inbox TO staff;
GRANT ALL ON TABLE clin_referrals.link_referral_condition TO staff;
...
GRANT ALL ON TABLE clin_workcover.link_claim_documents TO staff;
...
GRANT select, insert ON TABLE clin_prescribing.lu_brand TO staff;
GRANT select, insert ON TABLE clin_prescribing.lu_generics TO staff;
GRANT select, insert ON TABLE clin_prescribing.lu_instruction_habits TO staff;
GRANT select, insert ON TABLE clin_prescribing.lu_instructions TO staff;
GRANT select, insert ON TABLE clin_prescribing.lu_next_authority_number TO staff;
...
GRANT select, insert ON TABLE clin_recalls.forms TO staff;
...
GRANT select, insert ON TABLE clin_recalls.lu_status TO staff;
...
GRANT select ON TABLE clin_prescribing.lu_authority_indications TO staff;
GRANT select ON TABLE clin_prescribing.lu_pbs_status TO staff;
GRANT select ON TABLE clin_prescribing.medication_audit_reasons TO staff;
GRANT select ON TABLE clin_prescribing.medication_audit_trail TO staff;
GRANT select ON TABLE clin_prescribing.pack_details TO staff;
...
GRANT usage on SEQUENCE clin_pregnancy.lu_antenatal_venue_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.items_prescribed_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.link_generics_brands_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_authority_indications_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_brand_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_generics_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_instruction_habits_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_instructions_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_next_authority_number_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.lu_pbs_status_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.medication_audit_reasons_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.medication_audit_trail_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.medications_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.pack_details_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_prescribing.script_dates_pk_seq TO staff;
 ...
 GRANT USAGE ON SEQUENCE clin_recalls.forms_pk_seq TO staff;
...
GRANT usage on SEQUENCE clin_recalls.lu_templates_pk_seq TO staff;
 ...
 GRANT USAGE ON SEQUENCE clin_referrals.inbox_pk_seq TO staff;
 GRANT USAGE ON SEQUENCE clin_referrals.link_referral_condition_pk_seq TO staff;
...
GRANT usage on SEQUENCE clin_requests.lu_link_provider_user_requests_pk_seq TO staff;
 ...
 GRANT USAGE ON SEQUENCE clin_vaccination.data_pk_seq TO staff;
 ...
 GRANT USAGE ON SEQUENCE clin_workcover.link_claim_documents_pk_seq TO staff;
...
grant usage on sequence common.lu_occupations_pk_seq to staff;
 grant select on table drugs.restriction to staff;
 grant select, update on table admin.clinic_rooms_pk_seq to staff;
 grant select, update on table admin.lu_staff_roles_pk_seq to staff;
 grant select, update on table admin.lu_staff_status_pk_seq to staff;
 grant select on table drugs.schedule to staff;
 grant select on table drugs.severity_level to staff;
 grant select on table contacts.lu_employee_status to staff;
 grant select on table drugs.sources to staff;
 grant select on table drugs.topic to staff;
 grant select, insert on table blobs.backups to staff;
 grant select, insert, update on table clerical.task_component_notes to staff;
 grant select, update on table clerical.task_component_notes_pk_seq to staff;
 grant select, update, insert on table clerical.task_components to staff;
 grant select, update on table clerical.task_components_pk_seq to staff;
 grant select, update on table clerical.tasks_pk_seq to staff;
 grant select on table drugs.vwdrugs to staff;
 grant select on table drugs.brand_pk_key to staff;
 grant select on table drugs.clinical_effects_effect_key to staff;
 grant select on table drugs.company_company_key to staff;
 grant select, insert on table clin_certificates.certificate_reasons to staff;
 grant select, update on table clin_certificates.certificate_reasons_pk_seq to staff;
 grant select, update on table clin_consult.lu_actions_pk_seq to staff;
 grant select, update on table clin_consult.lu_audit_reasons_pk_seq to staff;
 grant select on table drugs.product_atccode_key to staff;
 grant select, update on table clin_mentalhealth.lu_assessment_tools_pk_tool_seq to staff;
 grant select on table drugs.brand to staff;
 grant select on table drugs.company to staff;
 grant select on table drugs.clinical_effects to staff;
 grant select, update on table blobs.images_pk_seq to staff;
 grant select on table drugs.info to staff;
 grant select on table drugs.atc to staff;
 grant select on table drugs.brand_pk_seq to staff;
 grant select on table drugs.chapter to staff;
 grant select on table drugs.clinical_effects_pk_seq to staff;
 grant select, update on table clin_prescribing.instruction_habits_pk_seq to staff;
 grant select on table drugs.evidence_levels to staff;
 grant select, update on table clin_prescribing.instructions_pk_seq to staff;
 grant select, update on table clin_prescribing.prescribed_for_habits_pk_seq to staff;
 grant select, update on table clin_prescribing.prescribed_for_pk_seq to staff;
 grant select, update on table clin_prescribing.prescribed_pk_seq to staff;
 grant select, update on table clin_prescribing.print_status_pk_seq to staff;
 grant select, update on table clin_requests.inbox_oru_unresolved_temp_patient_id_seq to staff;
 grant select, update on table clin_prescribing.script_numbers_pk_seq to staff;
 grant select on table drugs.flags to staff;
 grant select, update on table clin_requests.lu_request_type_pk_seq to staff;
 grant select, update on table clin_requests.request_providers_pk_seq to staff;
 grant select on table clin_prescribing.vwinstructionhabits to staff;
 grant select on table clin_prescribing.vwstartlast to staff;
 grant select on table drugs.flags_pk_seq to staff;
 grant select on table drugs.form to staff;
 grant select on table clin_prescribing.vwprescribedforhabits to staff;
 grant select on table drugs.info_pk_seq to staff;
 grant select on table drugs.link_atc_info to staff;
 grant select on table drugs.link_category_info to staff;
 grant select on table drugs.link_flag_product to staff;
 grant select, update, insert on table clin_vaccination.vaccine_serial_numbers to staff;
 grant select, update on table clin_vaccination.vaccine_serial_numbers_pk_seq to staff;
 grant select on table clin_vaccination.vwvaccinesinschedule to staff;
 grant select on table drugs.pack to staff;
 grant select on table drugs.patient_categories to staff;
 grant select, insert, update on table coding.user_terms_pk_seq to staff;
 grant select, insert, update, delete on table contacts.lu_mismatched_towns_pk_seq to staff;
 grant select on table drugs.pbs to staff;
 grant select on table drugs.pharmacologic_mechanisms to staff;
 grant select on table defaults.lu_message_display_style to staff;
 grant select on table defaults.lu_message_standard to staff;
 grant select on table drugs.product to staff;
 grant select on table documents.lu_display_as to staff;
 grant select on table drugs.product_pk_seq to staff;
 grant select on table documents.lu_display_as_pk_seq to staff;
 grant select on table documents.lu_message_display_style_pk_seq to staff;
 grant all on table clin_consult.lu_progressnote_templates_pk_seq to staff;
 grant all on table clin_requests.request_providers to staff;
 grant select, update on table clin_referrals.inclusions_pk_seq to staff;
 grant select, update on table clin_vaccination.vaccinations_pk_seq to staff;
 grant select, update, insert on table documents.unmatched_types to staff;
 grant select on table chronic_disease_management.lu_allied_health_type to staff;
 grant select, update on table chronic_disease_management.epc_referral_pk_seq to staff;
 grant select, update, insert on table chronic_disease_management.epc_referral to staff;
 grant select, update, insert on table clerical.tasks to staff;
 grant all on table clerical.schedule_pk_seq to staff;
 grant select, update on table chronic_disease_management.epc_link_provider_form_pk_seq to staff;
 grant all on table chronic_disease_management.epc_link_provider_form to staff;
 grant select, update on table chronic_disease_management.team_care_arrangements_pk_seq to staff;
 grant all on table chronic_disease_management.team_care_arrangements to staff;
 grant select, insert, update on table clin_certificates.medical_certificates to staff;
 grant select, update on table clerical.invoices_pk_seq to staff;
 grant select, update on table clerical.items_billed_pk_seq to staff;
 grant select, insert, update on table clerical.items_billed to staff;
 grant select, update on table clerical.payments_received_pk_seq to staff;
