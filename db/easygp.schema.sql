...
ALTER TABLE pbs_script_type ALTER COLUMN pk SET DEFAULT nextval('print_status_pk_seq'::regclass);
...
ALTER TABLE brand ALTER COLUMN pk SET DEFAULT nextval('brand_pk_seq'::regclass);
