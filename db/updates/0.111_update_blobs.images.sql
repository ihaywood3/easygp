-- added ability to descriptively tag an image

 alter Table blobs.images add column tag text default null;

comment on column blobs.images.tag is 'a descriptive tag of an image e.g Basal Cell Carcinoma - Left Ear';

drop view blobs.vwPatientImages; -- no cascades


CREATE OR REPLACE VIEW blobs.vwpatientimages AS 
 SELECT images.pk, images.image, images.deleted, images.fk_consult, images.md5sum, images.tag, consult.consult_date, consult.fk_patient
...
lu_marital.marital, lu_sex.sex, lu_occupations.occupation, lu_ethnicity.ethnicity, lu_languages.language, images.image, images.md5sum, images.tag, images.fk_consult as fk_consult_image, 
...
CREATE OR REPLACE VIEW contacts.vwpatients AS 
 SELECT 
        ...
        images.pk AS fk_image, images.image, images.md5sum, images.tag, images.fk_consult as fk_consult_image
...
CREATE OR REPLACE VIEW contacts.vwpersonsincludingpatients AS 
 SELECT persons.pk AS fk_person, 
        ...
        towns.town, towns.state, towns.postcode, addresses.fk_town, addresses.preferred_address, addresses.postal_address, addresses.head_office,
         ...
         persons.date_deceased, persons.fk_sex, images.pk AS fk_image, images.image, images.md5sum, images.tag, images.fk_consult as fk_consult_image
   FROM contacts.data_persons persons
...
CREATE OR REPLACE VIEW clin_procedures.vwimages AS 
 SELECT images.image, images.md5sum, images.tag, images.deleted as image_deleted, images.fk_consult as fk_consult_image, link_images_procedures.fk_image, link_images_procedures.fk_procedure, link_images_procedures.deleted,
...
insert into db.lu_version (lu_major,lu_minor) values (0, 111);
