-- added latex definition of the certificate - no default as I have already written many medical certificates.

alter table clin_certificates.medical_certificates add column latex text;

COMMENT ON COLUMN clin_certificates.medical_certificates.latex is
 'the latex text of the certificate';
...
CREATE OR REPLACE VIEW clin_certificates.vwmedicalcertificates AS 
 ...
 medical_certificates.to_date, medical_certificates.notes, medical_certificates.fk_progressnote, medical_certificates.latex, consult.fk_staff, 
 vwstaffinclinics.wholename AS staff_wholename, vwstaffinclinics.title AS staff_title, vwstaffinclinics.branch AS staff_branch, 
 vwstaffinclinics.organisation AS staff_organisation, vwstaffinclinics.street1 AS staff_street1, vwstaffinclinics.street2 AS staff_street2, 
 vwstaffinclinics.town AS staff_town, vwstaffinclinics.postcode AS staff_postcode, vwstaffinclinics.provider_number AS staff_provider_number, 
...
insert into db.lu_version (lu_major,lu_minor) values (0, 135);
