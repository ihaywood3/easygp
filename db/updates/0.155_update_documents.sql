...
-- cascades to vwhl7filesimported 
...
CREATE OR REPLACE VIEW documents.vwdocuments AS 
 ...
 documents.fk_staff_filed_document, documents.originator, documents.originator_reference,
 documents.copy_to, documents.provider_of_service_reference, documents.internal_reference,
 documents.copies_to, documents.fk_staff_destination, documents.comment_on_document,
 documents.patient_access, documents.concluded, documents.deleted, documents.fk_lu_urgency,
 documents.tag, documents.tag_user, documents.md5sum, documents.html,
 ...
 documents.fk_staff_permitted_access,
 ...
 vwsendingentities.organisation, vwsendingentities.organisation_category,
 ...
 vwpatients.sex AS patient_sex, vwpatients.age_numeric AS patient_age,
 vwpatients.title AS patient_title, vwpatients.street1 AS patient_street1,
 vwpatients.street2 AS patient_street2, vwpatients.town AS patient_town,
...
insert into db.lu_version (lu_major,lu_minor) values (0, 155);
