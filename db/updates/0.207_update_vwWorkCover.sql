...
CREATE OR REPLACE VIEW clin_workcover.vwworkcover AS 
 ...
 claims.deleted AS claim_deleted, consult.fk_staff, consult.fk_type, consult.summary,
 vwstaff.wholename AS staff_wholename, vwstaff.surname AS staff_surname, vwstaff.firstname AS staff_firstname,
 vwstaff.title AS staff_title, vwstaff.provider_number, lu_occupations.occupation, vworganisations.branch,
 vworganisations.fk_organisation, vworganisations.organisation, vworganisations.street1 AS branch_street1,
 vworganisations.street2 AS branch_street2, vworganisations.town AS branch_town,
 vworganisations.branch_deleted, vwpersons.wholename AS soletrader_wholename,
 ...
 vwpersons.street1 AS soletrader_street1, vwpersons.street2 AS soletrader_street2,
 ...
 visits.latex, visits.deleted AS visit_deleted, lu_caused_by_employment.caused_by_employment,
...
COMMENT ON VIEW clin_workcover.vwworkcover
  IS 'View of all visits for all claims date ordered.
                                              If the work cover form was coded also contains the coding system
                                              the coded term and the code';

truncate db.lu_version;
insert into db.lu_version (lu_major,lu_minor) values (0, 207);
