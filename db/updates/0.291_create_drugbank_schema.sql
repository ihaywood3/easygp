...
GRANT SELECT ON TABLE drugbank.atc_codes to staff;

ALTER TABLE drugbank.brands   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.brands to staff;

ALTER TABLE drugbank.categories   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.categories to staff;

ALTER TABLE drugbank.dosage   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.dosage to staff;

ALTER TABLE drugbank.drug   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.drug to staff;

ALTER TABLE drugbank.drug_interactions   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.drug_interactions to staff;

ALTER TABLE drugbank.external_links   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.external_links to staff;

ALTER TABLE drugbank.food_interactions   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.food_interactions to staff;

ALTER TABLE drugbank.general_references   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.general_references to staff;

ALTER TABLE drugbank.link_drug_to_atc_code   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.link_drug_to_atc_code to staff;

ALTER TABLE drugbank.link_drug_to_category   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.link_drug_to_category to staff;

ALTER TABLE drugbank.link_drug_to_dosage   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.link_drug_to_dosage to staff;

ALTER TABLE drugbank.link_drug_to_category   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.link_drug_to_category to staff;

ALTER TABLE drugbank.lu_external_resources   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.lu_external_resources to staff;

ALTER TABLE drugbank.patents   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.patents to staff;

ALTER TABLE drugbank.salts   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.salts to staff;


ALTER TABLE drugbank.synonyms   OWNER TO easygp;
GRANT SELECT ON TABLE drugbank.synonyms to staff;

truncate db.lu_version;
insert into db.lu_version (lu_major,lu_minor) values (0, 291);
