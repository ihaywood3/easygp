-- add confidentiality to recreational drugs
alter table clin_history.recreational_drugs add column confidential boolean default false;
-- redo the view
drop view clin_history.vwrecreationaldrugsused;
CREATE OR REPLACE VIEW clin_history.vwrecreationaldrugsused AS 
 SELECT recreational_drugs.pk, data_patients.pk AS fk_patient, 
 lu_recreational_drugs.drug, lu_recreational_drugs.alternative_names, 
 lu_route_administration.route, recreational_drugs.fk_consult, 
 ...
 recreational_drugs.fk_lu_route_administration, recreational_drugs.notes, 
 recreational_drugs.deleted, recreational_drugs.never_used_drug, 
...
insert into db.lu_version (lu_major,lu_minor) values (0, 330)
