-- dropped a column not currently used

alter table clin_mentalhealth.mentalhealth_plan drop column fk_stress_assessment cascade;
-- DROP VIEW clin_mentalhealth.vwmentalhealthplans;
...
CREATE OR REPLACE VIEW clin_mentalhealth.vwmentalhealthplans AS 
 SELECT mentalhealth_plan.pk AS pk_mentalhealth_plan,
    ...
    mentalhealth_plan.fk_pasthistory,
