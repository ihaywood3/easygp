...
-- IAN THIS TABLE WAS DROPPED DURING OUR CONSTRAINT WORKS ALTER TABLE clin_consult.lu_shortcut add constraint "lu_shortcut_fk_staff_fkey" foreign key (fk_staff) references admin.staff (pk);
...
-- ALTER TABLE clin_prescribing.prescribed_for_habits add constraint "prescribed_for_habits_fk_brand_fkey" foreign key (fk_brand) references  drugs.brand(pk);
