-- View: billing.vwdaysinvoicesandpayments
-- adds number_of_patients to the view to improve accuracy for multiple patient rule
...
update db.lu_version set lu_minor = 508;