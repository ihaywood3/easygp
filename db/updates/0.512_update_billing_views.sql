...
-- renamed the description field of lu_codes to reason_code_description in the view to make more sense
...
CREATE OR REPLACE VIEW billing.vwitemsandinvoices AS 
 SELECT vwitemsbilled.pk_items_billed,
    ...
    vwitemsbilled.reason_code_description,
...
update db.lu_version set lu_minor = 512;