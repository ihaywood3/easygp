...
-- added another three fields from vwPatients, language, language_problems and appointment_memo
-- to enable this data to be shown in an appointment slot
...
update db.lu_version set lu_minor = 513;
