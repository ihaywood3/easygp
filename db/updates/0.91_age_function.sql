...
create view clerical.vwtaskscomponents as
...
create view documents.vwhl7filesimported as
...
grant select on documents.vwhl7filesimported to staff;

create view clerical.vwtaskscomponentsandnotes as
 SELECT 
        CASE
...
create view clin_requests.vwrequestsordered as
