...
SELECT pg_catalog.setval('lu_billing_type_pk_seq', 8, true);
...
SELECT pg_catalog.setval('lu_bulk_billing_type_pk_seq', 2, true);


--
-- Data for Name: lu_codes; Type: TABLE DATA; Schema: billing; Owner: easygp
--

COPY lu_codes (code, description) FROM stdin;
0	Success
...
4013	Invoice deleted using same-day delete function
\.
...
SELECT pg_catalog.setval('lu_default_billing_level_pk_seq', 5, true);
...
SELECT pg_catalog.setval('lu_invoice_comments_pk_seq', 1, true);
...
SELECT pg_catalog.setval('lu_payment_method_pk_seq', 4, true);
...
SELECT pg_catalog.setval('lu_reasons_not_billed_pk_seq', 11, true);
...
COPY lu_reports (pk, report_title, sql, plot, fk_subreport, subkey) FROM stdin;
\.
...
SELECT pg_catalog.setval('lu_reports_pk_seq', 3, true);
